import { EngineOptions } from '../types/index';
  ...
  rules: {
    ...
    imageSearch: {
      ...
      options: [
        {
          name: 'Google 按图搜索',
          url: 'https://images.google.com.hk/searchbyimage?image_url={%url%}&hl=zh-CN&newwindow=1&safe=strict',
        },
        {
          name: 'Yandex 按图搜索',
          url: 'https://yandex.ru/images/search?text={%url%}&family=yes',
        },
      ],
    },
  },
